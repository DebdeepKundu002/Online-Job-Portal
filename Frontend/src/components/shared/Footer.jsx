      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Job Finder <span className='text-sm font-normal'>developed by Debdeep Kundu</span></h2>
            <p className="text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>

          <div className="mb-4 md:mb-0">
            <div className='text-xl'> Connect With Me </div>
            <div className="flex space-x-4 mt-4 md:mt-0 px-8">
              <a href="https://www.facebook.com/debdeepkundu.sonai" className="hover:text-gray-400" aria-label="Facebook">
              ...
              <a href="https://x.com/Debdeepkun66543" className="hover:text-gray-400" aria-label="Twitter">
              ...
              <a href="https://www.linkedin.com/in/debdeep-kundu-6a0617225/" className="hover:text-gray-400" aria-label="LinkedIn">
